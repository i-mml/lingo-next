...
const AudioQuestionTextAnswer: React.FC<AudioQuestionTextAnswerProps> = ({
  activity,
  handleNext,
}) => {
  ...
  return (
    <div className="w-full">
      ...
      <div className="text-center mb-4">
        <h2 className="text-xl font-bold text-main">{activity.statement}</h2>
      </div>
      {/* Audio */}
      <div className="flex flex-col items-center mb-8">
        ...
        <audio ref={audioRef} src={activity.audio} />
      </div>
      {/* Input */}
...
export default AudioQuestionTextAnswer;
